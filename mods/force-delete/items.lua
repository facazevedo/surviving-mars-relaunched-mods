return {
	...
	PlaceObj('ModItemCode', {
		'name', "fd_config",
		'CodeFileName', "Code/fd_config.lua",
	}),
	PlaceObj('ModItemCode', {
		'name', "fd_display_attributes",
		'CodeFileName', "Code/fd_display_attributes.lua",
	}),
	PlaceObj('ModItemCode', {
		'name', "fd_colonist",
