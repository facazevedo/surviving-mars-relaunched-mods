...
- `force-delete` v3 - Press `Ctrl+Delete` to immediately run demolition cleanup for the selected demolishable object, useful for bugged objects such as stuck train tracks.
